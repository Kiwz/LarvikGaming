...
public class CmdLogger {
	...
	public void cmdLogger(String player, String message) {

		Plugin larvikGaming = Bukkit.getServer().getPluginManager().getPlugin("LarvikGaming");
		String fileName = larvikGaming.getConfig().getString("FileDir", "plugins/LarvikGaming/files") + "/logs/cmd_log.txt";
		Format sdf = new SimpleDateFormat(larvikGaming.getConfig().getString("TimeFormat", "yyyy-MM-dd HH:mm:ss"));
		Date date = new Date();
		String time = sdf.format(date);
		List<String> cmdsToLog = larvikGaming.getConfig().getStringList("CmdToLog");
	...
	public void privMsgLogger(String player, String message) {
		...
		Plugin larvikGaming = Bukkit.getServer().getPluginManager().getPlugin("LarvikGaming");
		String fileName = larvikGaming.getConfig().getString("FileDir", "plugins/dynmap/web/admin") + "/logs/msg_log.txt";
		Format sdf = new SimpleDateFormat(larvikGaming.getConfig().getString("TimeFormat", "yyyy-MM-dd HH:mm:ss"));
		Date date = new Date();
		String time = sdf.format(date);
