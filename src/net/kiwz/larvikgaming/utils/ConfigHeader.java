...
public class ConfigHeader {
	...
	public static String header() {
		...
		String s04 = "</lginfo> <mclarvik.info> Displayes  some information about this plugin." + n;
		String s05 = "</lgreload> <mclrvik.reload> Reloads this plugin." + n;
		String s06 = "</lgrestart> <mclarvik.restart> Restarts the server completly." + n;
		String s07 = "</lgcopy> <mclarvik.copy> Copies all the files in 'FilesToCopy'." + n;
		String s08 = "</lggroups> <mclarvik.groups> Generates a txt file with bPerm's users sortet into groups." + n + n;
		...
		String header = s01 + s02 + s03 + s04 + s05 + s06 + s07 + s08 + s09 + s10 +
